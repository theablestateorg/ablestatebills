...
function Notifications({ notify, notifications }) {
  ...
  return (
    <>
      {notifications && notifications.length > 0 && (
        <span className="w-3 h-3 p-2 right-1 z-10 top-0  bg-[#CA3011] text-xs text-white rounded-full absolute flex justify-center items-center">
        ...
        <div className="absolute top-[50px] right-0 w-96 h-[500px] overflow-hidden shadow-md pt-4 pb-1 bg-white rounded flex flex-col">
          <div className="flex flex-col px-2 border-b-2 pt-2">
            ...
            <ul className="flex justify-between px-5">
              <li className="font-bold border-b-2 border-black">
                All{" "}
                <span className="bg-black text-white text-xs px-2 rounded font-medium">
                  {notifications.length}
                </span>
              </li>
            </ul>
              ...
              <Fragment key={index}>
                ...
                >
                  <div className="col-span-1 flex items-center justify-center h-16">
                    <span className="w-12 h-12 rounded-full flex justify-center items-center font-bold bg-orange-300">
                      {notification.actor[0].toUpperCase()}
                    </span>
                  </div>
