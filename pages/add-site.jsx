    ...
    <>
      ...
      <main className='pt-[70px] mx-5 md:mx-20 relative pb-6 min-h-screen'>
        ...
        <Formik
          ...
          onSubmit={(event, values, { resetForm }) => {
        ...
        >
          ...
          <div className="flex items-center gap-10 my-5">
            ...
            <Formik initialValues={{ password: "", first_name: "", last_name: "", role: "customer", email: ""  }}>
                {({ values, errors, touched, isValid, dirty, handleChange, handleBlur, resetForm }) => {
            return (
              <Form
              ...
              name="customerForm">
                ...
                <button type="button" disabled={!(isValid && dirty)} className="bg-[#1D1F20] text-white py-1 px-3 my-2 mt-4 hover:bg-[#292C2D] flex items-center cursor-pointer"
                onClick={() => { addNewCustomer(values)}}
                >
