...
export default function handler(req, res) {
  ...
  req.body?.day &&
    ...
    <div>
      ...
      <p>We noticed that your website <b>(${website.website_link})</b> will expire <b>today</b>. Please try to update it to make sure that it stays up and running</p>
  ...
  req.body?.week &&
    ...
    <div>
      <h1>Hi ${website.contact_person},</h1>
      <p>We noticed that your website <b>(${website.website_link})</b> will expire in <b>a week</b>. Please try to update it to make sure that it stays up and running</p>
  ...
  req.body?.month &&
    ...
    <div>
      <h1>Hi ${website.contact_person},</h1>
      <p>We noticed that your website <b>(${website.website_link})</b> will expire in <b>a month</b>. Please try to update it to make sure that it stays up and running</p>
  ...
  req.body?.two_months &&
    ...
    <div>
      <h1>Hi ${website.contact_person},</h1>
      <p>We noticed that your website <b>(${website.website_link})</b> will expire in <b>2 months</b>. Please try to update it to make sure that it stays up and running</p>
